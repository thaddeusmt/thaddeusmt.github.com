...
comments: true
categories: [Facebook]
keywords: facebook,iframe app,iframe tab,fbml,facebook app,facebook apps,fan gate,reveal tab,like gate
disqus_identifier: /2011/02/15/reveal-fan-gate-like-gate-facebook-iframe-tab-tutorial-with-php
---
